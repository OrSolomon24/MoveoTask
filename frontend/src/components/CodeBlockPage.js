...
const socket = io.connect('http://moveotaskbackend-production.up.railway.app/');
...
const CodeBlockPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`http://moveotaskbackend-production.up.railway.app/api/codeBlocks/${id}`);
